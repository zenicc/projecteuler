                ...
                if len(puzz[m][n]) == 2:
                    for c in range(n+1,10):
                        if set(puzz[m][n]) == set(puzz[m][c]):
                            for x in range(1,10):
                                if len(puzz[m][x]) > 2 and not(len(set(puzz[m][x]) - set(puzz[m][n])) == len(set(puzz[m][x]))):
                                    puzz[m][x] = list(set(puzz[m][x]) - set(puzz[m][n]))
                                    changed = True
                    for r in range(m+1,10):
                        if set(puzz[m][n]) == set(puzz[r][n]):
                            for y in range(1,10):
                                if len(puzz[y][n]) > 2 and not(len(set(puzz[y][n]) - set(puzz[m][n])) == len(set(puzz[y][n]))):
                            ...
                            if set(puzz[m][n]) == set(puzz[r][c]) and not(r == m and c == n):
                                ...
                                for r1 in range(subr1, subr1 + 3):
                                    for c1 in range(subc1, subc1 + 3):
                                        if len(puzz[r1][c1]) > 2 and not(len(set(puzz[r1][c1]) - set(puzz[m][n])) == len(set(puzz[r1][c1]))):
